...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Visualization and clustering pipeline for the raw dongdat.csv dataset."
    )
    parser.add_argument("--input-csv", type=Path, default=Path("data/dongdat.csv"))
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("hoigreen/clustering_pattern_mining/raw_outputs"),
    )
...
def build_report(
    ...
    report = f"""# Visualization and Clustering Report
